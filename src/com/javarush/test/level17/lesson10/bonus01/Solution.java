...
public class Solution {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        if (args[0].equals("-c")) {
            ...
            System.out.println(allPeople.get(Integer.parseInt(args[1])).getName() + " " + (allPeople.get(Integer.parseInt(args[1])).getSex().equals(Sex.MALE) ? "м" : "ж") + " " + outDateFormat.format(allPeople.get(Integer.parseInt(args[1])).getBirthDay()));
        }
    }
}
